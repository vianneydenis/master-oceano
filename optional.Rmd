...
description: |
 List of optional courses in English and by topic. Click on their title for a short description of the course. Download syllabus by clicking on course code. 
---
...
<summary><span style="color:#1D5287">**English Writing in Marine Sciences**</span> <a href=".\syllabus\OCEAN7168.pdf"target="_blank"> (OCEAN 7168)</a> - 3 credits </summary>
...
<details>
<summary><span style="color:#1D5287">**Scientific Communication in English**</span>  <a href=".\syllabus\OCEAN7192.pdf"target="_blank"> (OCEAN 7192)</a> - 1 credit</summary>



**Description**: This course is designed to guide graduate students in communicating science professionally, with emphasis on training/practicing. More than half of the class hours will be on discussion and implementation of theories. The second half of the semester will focus on scientific/thesis writing skills. For IONTU students, this can serve as a supplemental course to each division’s seminar course. Course designed for students with background in science. Objective are: 1) Students get to practice scientific communication skills, including poster and oral presentations. (2) Students learn to apply the theories learnt in class or elsewhere. (3) Students get to practice scientific writing in English, as well as English skills in scientific correspondence and conferences.  

**Instructor**: Sze Ling HO
</details>


<details>
<summary><span style="color:#1D5287">**Paper Reading**</span> ([OCEAN 7005]()) - 1 credit</summary>
**Description**: the class aims to establish students' ability to read, understand, present, question, and discuss research topics by presenting a textbook chapter and scientific paper. Students are required to preparing abstracts and 35-minute presentations. We expect the presentations to go beyond the textbook contents or selected papers to acquire additional materials when necessary.
...
with perspectives in terms of reef management. Overall, through the lectures, the students will be provided
with an up-to-date understanding of the coral reef crisis and the immediate actions to take for the long-term
conservation of these fragile ecosystems. Many examples will be based on reefs in Taiwan, and speakers may
be invited to illustrate specific topics.
...
<details>
<summary><span style="color:#1D5287">**Biological modeling**</span> <a href=".\syllabus\OCEAN5074.pdf"target="_blank"> (OCEAN 5074)</a> - 3 credits </summary>
...
<details>
<summary><span style="color:#1D5287">**Computer-Intensive Statistics in Ecology**</span> <a href=".\syllabus\OCEAN5052.pdf"target="_blank"> (OCEAN 5052)</a> - 3 credits </summary>
...
**Instructor**: Chih-hao HSIEH; Hui-Yu WANG; Yi-Jay CHANG
</details>
...
<details>
<summary><span style="color:#1D5287">**Invitation to Paleoceanography**</span> ([OCEAN 5126]()) - 2 credits</summary>
**Description**: This course aims to introduce an interdisciplinary branch of science, known as paleoceanography (knowledge of ancient oceans), to students with no prior background. Ocean is an integral part of the Earth’s climate system, thus mechanistic understanding of how oceans change in the past will improve overall understanding of global climate change. The lecture contents are across disciplines, ranging from general oceanography, climate change, formation process of marine sediments, geochemical indicators used as proxies of past oceanic change, to the instruments used to generate these geochemical data. The course is suitable for oceanography / geoscience / Earth science / geography students who are curious about climate change, paleoceanography and paleoclimate. It is especially useful for students who plan to carry out graduate research in paleoceanography, either as introductory or refresher course. The course will adopt inquiry-based learning (student-led learning). Critical thinking questions will be provided to steer discussion. The goal of the course is to ensure that students can apply the knowledge and theories learnt in class and to link different topics across disciplines. Students will achieve basic understanding on how climate changes on Earth and especially the oceans can be reconstructed using marine sediments. The inquiry-based approach will train students in critical thinking, problem solving and independent learning – all of these skills are essential for a career in academia and industry. There will be plenty of opportunities for discussion and debate to train students’ communication skills. The interdisciplinary nature of climate science exposes students to various fields of study and approaches used, which helps to broaden their horizon beyond their major. 

**Instructor**: Sze Ling HO
</details>

<details>
<summary><span style="color:#1D5287">**Climate and Ocean**</span> ([OCEAN 5112]()) - 2 credits</summary>
**Description**: This is an introductory course on Earth’s climate, and its link to the ocean which covers 70% of the Earth’s surface. Emphasis is on climate changes since the past 50 Million years at different time-scales and how these changes can be inferred using different climate archives. Students will achieve basic understanding on how climate changes on Earth, as well as be exposed to unresolved issues in climate science. The latter will train students in critical thinking and debate, i.e. skills which will be especially helpful for students who are interested in graduate research. The interdisciplinary nature of climate science exposes students to various fields of study and approaches used, which helps to broaden their horizon beyond their major.   
...
<details>
<summary><span style="color:#1D5287">**Paleoclimate Proxies in Marine Sediments**</span> ([OCEAN 7185]()) - 2 credits</summary>
**Description**: This course is designed to guide graduate students in communicating science professionally, with emphasis on training/practicing. More than half of the class hours will be on discussion and implementation of theories. The second half of the semester will focus on scientific/thesis writing skills. For IONTU students, this can serve as a supplemental course to each division’s seminar course. Course designed for students with background in science. Objective are: 1) Students get to practice scientific communication skills, including poster and oral presentations. (2) Students learn to apply the theories learnt in class or elsewhere. (3) Students get to practice scientific writing in English, as well as English skills in scientific correspondence and conferences.   
...
<details>
<summary><span style="color:#1D5287">**Environmental chemistry and sustainable management of coral reefs (field visit included)**</span> <a href=".\syllabus\OCEAN7193.pdf"target="_blank"> (OCEAN 7193)</a>  - 3 credits</summary>
