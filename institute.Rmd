...
```{r, echo=F, fig.align = "default", fig.cap="Interactive map of IONTU's location"}
library(leaflet)
leaflet() %>%
...
```{r, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "default", fig.cap="The Institute of Oceanography"}
knitr::include_graphics("images/IONTU_Building_A.jpg")
```
...
```{r, echo=FALSE, fig.show = "hold", out.width = "50%", fig.align = "center", fig.cap="IONTU interactive classroom"}
knitr::include_graphics("images/IONTU_classroom.jpg")
```
